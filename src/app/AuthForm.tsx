    ...
    return (
        <div className="max-w-md mx-auto mt-16 p-8 bg-white rounded shadow">
            ...
            <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded shadow-sm bg-white text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-black transition-colors"
            >
                {isLoading ? (
